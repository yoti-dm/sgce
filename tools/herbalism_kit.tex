...
A special knot that can be undone as part of any necromatic spell to rise spell save DC / spell attack modifier by one. Must be used when declaring attack, before knowing whether spell hit or not. Only one such knot can be used per spell cast. Item is spent on use.
...
Grants +2 to \constitution for 1 hour. This effect does not stack.
...
Creates dried chips that can be consumed as part of illusion spell to rise spell save DC / spell attack modifier by one. Must be used when declaring attack, before knowing whether spell hit or not. Only one such chips can be used per spell cast. Item is spent on use.
...
Minor & \dice{1d4+1} & 12 & 1 hour & 1 \\
Regular & \dice{2d4+2} & 14 & 2 hours & 2 \\
Greater & \dice{4d4+4} & 16 & 4 hours & 3 \\
Superior & \dice{8d4+8} & 18 & 8 hours & 4 \\
Supreme & \dice{10d4+20} & 20 & 16 hours & 5 \\
\end{dndtable}
...
Infuses Healing apple with magic. Eating infused healing apple heals for \dice{1d4}.
...
Bright red powder that explodes with radius of 5 feet when in contact with fire and deals \dice{1d8} fire damage (DC 18 \dexteritysave{} reduces to half).
...
but suffer \dice{1d6} poison damage at the beginning of their turn until paint is removed. Removing dry paint requires action. 
...
\dice{1d8} to non vampires (DC 16 \constitutionsave{} to reduce to half). Single use, fades in one hour after being applied if not used.
